...
class AudioEngine {
  ...
  getNoteFrequency(note) {
    ...
    const frequencies = {
      ...
      'BB.': 233.08,
      'H.': 246.94,   // H3/B3
      // Jednočárkovaná oktáva (C4 = c')
      'C': 261.63,    // C4 (c' - jednočárkované)
      'C#': 277.18,   // C#4/Db4
      'DB': 277.18,
      'D': 293.66,    // D4
      'D#': 311.13,   // D#4/Eb4
      ...
      'BB': 466.16,
      'H': 493.88,    // H4/B4
      // Dvoučárkovaná oktáva (C5 = c'')
      "C''": 523.25,   // C5 (c'' - dvoučárkované)
      "C#''": 554.37,  // C#5/Db5
      "D''": 587.33,   // D5
      "D#''": 622.25,  // D#5/Eb5
      "E''": 659.25,   // E5
      ...
      "A#''": 932.33,  // A#5/Bb5
      "H''": 987.77,   // H5/B5
      // Aliasy s jednou čárkou pro zpětnou kompatibilitu
      "C'": 523.25,
      "C#'": 554.37,
      "DB'": 554.37,
      "D'": 587.33,
